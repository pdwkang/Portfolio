	...
	render(){
		return(
			<div className='skill-icons-wrapper'>
				...
				<div className='col-md-2 hidden-xs col-xs-4 hidden-sm each-icon soucretree'><div className='icon-image'><img src={require('./images/sourcetree.png')} alt='Please let me know!' /></div><div className='border-div'></div><div className='icon-name'>SourceTree</div></div>
	...
	render(){
		return(
			<div className='skills-header'>
				<div className='skills-header-title'>Skills and Dev Tools?</div>
			</div>
		)
	}
}
