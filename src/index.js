					...
					<div className='portfolio-background'>
						...
						<div id='portfolio1' className='portfolio1'>
						 	<div className='hidden-xs hidden-sm'>
						    	<button className='btn btn-primary' style={{position:'absolute', right:15, top:85, zIndex:6, backgroundColor:'rgba(25,44,255,0.4)', fontFamily:'Libre Franklin'}} onClick={this.openModal}>Linting The Code</button>
